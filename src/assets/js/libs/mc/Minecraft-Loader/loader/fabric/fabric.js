...
class FabricMC extends events_1.EventEmitter {
    ...
    async downloadJson(Loader) {
        ...
        try {
            ...
            metaData = JSON.parse(fs_1.default.readFileSync(path_1.default.resolve(this.options.path, '..', '..', 'battly', 'launcher', 'fabric', this.options.loader.version, 'metaData.json'), 'utf-8'));
        }
        ...
        try {
            ...
            json = JSON.parse(fs_1.default.readFileSync(path_1.default.resolve(this.options.path, '..', '..', 'battly', 'launcher', 'fabric', this.options.loader.version, 'fabric.json'), 'utf-8'));
        }
        return json;
    }
